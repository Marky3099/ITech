  ...
  <div class="modal-dialog" id="dialog2" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="adata">
          ...
          <div class="form-group">
            <h5>Title</h5>
            <input class="form-control" type="text" name="title_update" id="title_update" placeholder="Title" style="width:150px;" disabled>
          </div>
          <div class="form-group">
            <h5>Time</h5>
          ...
          <div class="form-group">
            ...
            <h5>Service</h5>
            <select class="form-control" id="serv_id_update" name="serv_id_update"style="width: 120px;" disabled>
              <?php foreach($serv as $ser):  ?>
                  <option value=<?php echo $ser['serv_id']; ?>><?php echo $ser['serv_name'];?></option>
              <?php endforeach; ?>
            </select>
