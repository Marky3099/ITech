...
$pdf->SetTitle('Today\'s Scheduled Tasks');
$pdf->SetSubject('Today\'s Scheduled Tasks');
...
$html = '<span style="text-align: center;"><b>Today\'s Scheduled Tasks - '.date('F j, Y').'</b><br></span><br><br><br><br>';
$pdf->SetXY(25, 45);
...
$html .= '<table cellspacing="0" cellpadding="15" border="1" id="table1">
     ...
     foreach($day as $d){
				   ...
				   $html .='     <tr style="font-size:9px; text-align: center;">
                             ...
                             <td>'.$d->area.'</td>
                             <td>'.$d->client_branch.'</td>
                             <td>'.$d->serv_name.'</td>
                             <td>'.$d->device_brand.'</td>
                             <td>'.$d->aircon_type.'</td><td>';
                    ...
                    $html .='</td>';
				     $html .='<td style="color:#4F6FA6;">'.$d->status.'</td>
				          </tr>';
...
$pdf->Output('Today\'s_Tasks_Report_'.date('F j, Y').'.pdf', 'D');
