                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           ...
                           <div class="form-group">
                              ...
                              <a href="<?= base_url('/calendar/events/filtered/print/'.$_GET['start_date']."/".$_GET['to_date'])?>" target="_blank" class="btn btn-success" id="print">Download</a>
                              <?php endif; ?>
                           </div>
                        </div>
                     </div>
      ...
      <table class="table table-bordered" id="table1">
       ...
       <tbody>
          ...
          <tr>
            ...
            <?php endif;?>
             <td>
                 <a href="<?= base_url('/calendar/delete/'.$dat->id);?>" class="btn btn-danger btn-sm">Delete</a>
             </td>
          </tr>
          <?php endforeach; ?>
