...
$pdf->SetTitle('Monthly Scheduled Tasks');
$pdf->SetSubject('Monthly Scheduled Tasks');
...
$html = '<span style="text-align: center;"><b>Monthly Scheduled Tasks - '.date('F Y').'</b><br></span><br><br><br><br>';
$pdf->SetXY(25, 45);
...
$pdf->Output('Monthly_Tasks_Report_'.date('F Y').'.pdf', 'D');
