...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        if($this->type == 'partnered'){
            $html = 'Partnered Users List';
        }else{
            $html = 'Non-Partnered Users List';
        }
...
if($type == 'partnered'){
    $pdf->SetTitle('Partnered Company Users List');
    $pdf->SetSubject('Partnered Company Users List');
}else{
    $pdf->SetTitle('Non-Partnered Company Users List');
    $pdf->SetSubject('Non-Partnered Company Users List');
}
