...
$html = '<span style="text-align: center;"><b>Detailed Accomplished Service/Tasks Report</b><br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;From '. date('F j, Y',strtotime($date[0])).' to '. date('F j, Y',strtotime($date[1])). '</span><br><br><br><br>';
$pdf->SetXY(25, 45);
...
$pdf->Output('Accomplished_Report_'.$date[0].'_to_'.$date[1].'.pdf', 'D');
