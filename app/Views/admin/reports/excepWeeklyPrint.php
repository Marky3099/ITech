...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $html = 'Detailed Exception Report from '.date('F j', $this->monday) .  ' to '  . date('F j Y', $this->sunday);
...
$pdf->Output('Exception_Report_'.date('F j',$pdf->monday).'-'.date('j, Y',$pdf->sunday).'.pdf', 'I');
exit();
//============================================================+
// END OF FILE
//============================================================+