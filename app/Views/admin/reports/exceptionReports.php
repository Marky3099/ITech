                  ...
                  <div class="col-lg-1">
                    <div class="form-group">
                        ...
                        <?php if(isset($_GET['start_date']) && isset($_GET['to_date']) && !isset($_GET['serv']) && !isset($_GET['client_id'])): ?>
                          <?php $serv = '""'?>
                          <?php $client_id = '""'?>
                          <a href="<?= base_url('/reports/exception/filtered/print/'.$_GET['start_date']."/".$_GET['to_date']."/".$serv."/".$client_id)?>" target="_blank" class="btn btn-info btn-sm" id="print">Print</a>
                        <?php elseif(isset($_GET['start_date']) && isset($_GET['to_date']) && isset($_GET['serv']) && isset($_GET['client_id'])):?>
                          <a href="<?= base_url('/reports/exception/filtered/print/'.$_GET['start_date']."/".$_GET['to_date']."/".$_GET['serv']."/".$_GET['client_id'])?>" target="_blank" class="btn btn-info btn-sm" id="print">Print</a>
                        <?php elseif(isset($_GET['start_date']) && isset($_GET['to_date']) && isset($_GET['serv']) && !isset($_GET['client_id'])):?>
                          <?php $client_id = '""'?>
                          <a href="<?= base_url('/reports/exception/filtered/print/'.$_GET['start_date']."/".$_GET['to_date']."/".$_GET['serv']."/".$client_id)?>" target="_blank" class="btn btn-info btn-sm" id="print">Print</a>
                        <?php elseif(isset($_GET['start_date']) && isset($_GET['to_date']) && !isset($_GET['serv']) && isset($_GET['client_id'])):?>
                          <?php $serv = '""'?>
                          <a href="<?= base_url('/reports/exception/filtered/print/'.$_GET['start_date']."/".$_GET['to_date']."/".$serv."/".$_GET['client_id'])?>" target="_blank" class="btn btn-info btn-sm" id="print">Print</a>   
