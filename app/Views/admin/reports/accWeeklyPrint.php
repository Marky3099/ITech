...
require_once($_SERVER['DOCUMENT_ROOT'].'tsms\app\libraries\tcpdf\tcpdf.php');
...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $html = 'Detailed Accomplished Service/Tasks Report from '.date('F j', $this->monday) .  ' to '  . date('F j Y', $this->sunday);
...
$pdf->branch = $cBranch;
$pdf->overall = 0;
$pdf->monday = strtotime('last monday', strtotime('tomorrow'));

$pdf->sunday = strtotime('+6 days', $pdf->monday);
// add a page
$pdf->AddPage('L');
...
$pdf->Output('Accomplished_Report_'.date('F j',$pdf->monday).'-'.date('j, Y',$pdf->sunday).'.pdf', 'I');
exit();
//============================================================+
// END OF FILE
//============================================================+
