...
<head>
  ...
  <title>Partnered Company Login</title>
    ...
    <div class="row">
      <div class="login-box col-12 col-lg-6 col-md-6 col-sm-12">
        ...
        <form class="login100-form validate-form" action="<?= base_url('pages/checkClient');?>" method="post">
          ...
          <div class="form-group user-box">
            <div class="icon-box" id="keyicon"><i class="fas fa-key"></i></div>
          ...
          <br><br>
          <div class="reg px-1">
            <b><p>Don't have an account yet?
            <a href="<?= base_url('/bdo-register');?>">Register now</a></p></b>
          </div>
