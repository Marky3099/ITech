...
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/page1.css')?>">
    	...
    	<div class="container">
			...
			<div class="box-content">
					...
					<p><i class="fas fa-chevron-circle-down"></i>&nbsp;Please click or tap type of account.</i></p>
						...
						<div class="btn-layer">
							<a href="<?= base_url('/login')?>" class="btn btn-success"><div class="icon-box"><i class="fas fa-user-shield"></i></div>Admin</a></br>
