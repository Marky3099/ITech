      ...
      <div class="login-box col-12 col-lg-6 col-md-6 col-sm-12">
        ...
        <form class="login100-form validate-form" action="<?= base_url('pages/checkEmployee');?>" method="post">
          ...
          <div class="form-group user-box">
            ...
            <input class="form-control" type="password" name="password" id="id_password" placeholder="Enter your Password" value="<?php if(isset($_POST['password'])) { echo $_POST['password']; }?>"><i class="far fa-eye fa-eye-slash" id="togglePassword"></i>
          </div>
