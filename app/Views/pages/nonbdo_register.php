    ...
    <form class="login100-form validate-form" action="<?= base_url('/non-bdo-register/add');?>" method="post">
      <div class="col-8 col-lg-8 col-md-8 col-sm-12">
        <div class="user-box">
          ...
          <input class="fname" type="text" name="fname" placeholder="First name" value="<?php if(isset($_POST['fname'])) { echo $_POST['fname']; }?>"><div class="icon-box1" id="ib1"><i class="fas fa-user-alt"></i></div>
